...
<div class="loginstart">
	...
	<input type="Email" name="email" class="logintextbox" placeholder="Enter Registered Email" /><br/><br/>
	<input type="submit" name="submit_email" value="SUBMIT EMAIL" class="forgotpassbtn">
