...
<body>
	...
	<audio id="myaudio2" controls autoplay hidden="true" > <source src="../Music/Chapter2.mp3"  type="audio/mp3"> </audio>
	...
	<div class="AdventureHome2" >
		<div class="mainChap2">
			...
			<h3>"FOR COMPLETING CHAPTER TWO"</h3>
			<br>
			<center><a href="Chapter3.php">Procceed to Chapter 3</a></center>
			</script>
		</div>
